...
class SetupUsersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $participants = [
            ['name' => 'Peserta 1', 'username' => 'peserta1', 'email' => 'peserta1@info-clash.com', 'institution' => 'Universitas A', 'team_name' => 'Tim Alpha'],
            ['name' => 'Peserta 2', 'username' => 'peserta2', 'email' => 'peserta2@info-clash.com', 'institution' => 'Universitas B', 'team_name' => 'Tim Beta'],
            ['name' => 'Peserta 3', 'username' => 'peserta3', 'email' => 'peserta3@info-clash.com', 'institution' => 'Universitas C', 'team_name' => 'Tim Gamma'],
        ];
